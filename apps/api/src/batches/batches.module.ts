...
@Module({
  imports: [TypeOrmModule.forFeature([Batch, Product, Warehouse, BatchLineItem, PurchaseOrder, PurchaseRequisition]), WarehousesModule, BinsModule, PurchaseOrder, SalesInquiryModule, PurchaseRequisitionsModule],
