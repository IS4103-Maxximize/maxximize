...
export const RetailersList = ({ orgId }) => {
  ...
  const updateOrganisation = (retailer) => {
    const indexOfEditOrg = retailers.findIndex(
      (currentRetailer) => currentRetailer.id === retailer.id
    );
  ...
  useEffect(() => {
    const filteredRows = retailers.filter((retailer) =>
  ...
  const handleDelete = async () => {
    ...
    const remainingRetailers = retailers.filter(
      (retailer) => !selectionModel.includes(retailer.id)
    );
          ...
          <CardContent>
            ...
            >
              ...
              >
                ...
                <Tooltip
                  title={
                    'Update a retailer by clicking on the menu button at the end of the row'
                  }
                >
                  <IconButton>
                    <HelpIcon />
